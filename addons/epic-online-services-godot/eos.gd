...
class UIConst:
	...
	class UIInterface:
		...
		static func get_notification_location_preference() -> EOS.UIConst.NotificationLocation:
			return IEOS.ui_interface_get_notification_location_preference()

		static func get_toggle_friends_key(options: GetToggleFriendsKeyOptions) -> EOS.UIConst.KeyCombination:
		...
		static func is_valid_key_combination(key_combination: EOS.UIConst.KeyCombination) -> bool:
			return IEOS.ui_interface_is_valid_key_combination(key_combination)

		static func set_display_preference(options: SetDisplayPreferenceOptions) -> EOS.UIConst.NotificationLocation:
