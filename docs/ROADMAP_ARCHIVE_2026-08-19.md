# Candela 2D — Détail technique de la feuille de route

> **[docs/ROADMAP.md](ROADMAP.md) a été simplifié le 2026-08-19** pour rester
> lisible par quelqu'un de non technique : état des phases, ce qui reste,
> titres des décisions et des pièges. **Tout le détail technique reste ici**
> — le pourquoi de chaque décision, l'explication complète de chaque piège,
> les journaux de mesure — et **ce fichier continue d'être tenu à jour** par
> les sessions de travail, exactement comme l'ancien `ROADMAP.md` l'était.
> Toute nouvelle entrée détaillée (piège, décision, mesure) va ici ; seul un
> résumé d'une ligne, si le sujet le justifie, remonte dans le document court.

---

# Candela 2D — Feuille de route (contenu hérité du 2026-08-19, avant simplification)
