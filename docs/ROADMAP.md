...
| 8 | Shimmer des murs | **Retiré le 2026-09-11** (`git revert`). Adrien ne voyait pas à quoi correspondait le scintillement, et une autre session (« Murs avec bande LED respirante ») remplace précisément cette animation du filament par une respiration régulière. Le shader est rendu tel quel à cette session. | ↩︎ retiré |
