...
SUITES=(test_map_codec test_map_geometry test_arena_build test_editor_tools
        ...
        test_vitrine_menus test_audit_menus test_pool_sfx test_musique test_oreille test_ecran_de_fin test_serie_de_session test_vision test_eblouissement test_brouillage test_rejeu test_banc test_prediction_tir
        test_mise_a_jour test_charte test_habillage test_autoloads test_torches test_lumieres test_viseur
        test_dosage_audio)
