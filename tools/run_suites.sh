...
SUITES=(test_liaisons test_icones_editeur
	test_map_codec test_map_geometry test_arena_build test_editor_tools
        ...
        test_vitrine_menus test_menu_artworks test_intro_planches test_audit_menus test_pool_sfx test_musique test_oreille test_ecran_de_fin test_serie_de_session test_vision test_eblouissement test_brouillage test_rejeu test_releve_balistique test_curseur_systeme test_curseur_joystick test_banc test_rendu_racine test_prediction_tir
