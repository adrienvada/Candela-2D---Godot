...
SUITES=(test_liaisons test_icones_editeur
	test_map_codec test_map_geometry test_mur_led test_arena_build test_editor_tools
        ...
        test_proto_iso test_voxel_corps test_voxel_objets test_banc_iso test_iso_geometrie test_iso_camera test_iso_vues test_iso_corps test_iso_murs_bas test_iso_objets test_iso_killcam test_killcam_calme test_iso_beaute test_iso_gadgets test_iso_torches3d test_corps_portraits test_corps_mannequin test_menus_voxel)
