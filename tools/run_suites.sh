...
SUITES=(test_map_codec test_map_geometry test_arena_build test_editor_tools
        ...
        test_vitrine_menus test_audit_menus test_pool_sfx test_musique test_oreille test_ecran_de_fin test_serie_de_session test_vision test_eblouissement test_rejeu test_banc test_prediction_tir
